package id.ac.pelitabangsa.uts_satriaarya.Activity;
...
import id.ac.pelitabangsa.uts_satriaarya.Fragment.About;
import id.ac.pelitabangsa.uts_satriaarya.Fragment.Contact;
import id.ac.pelitabangsa.uts_satriaarya.Fragment.Home;
import id.ac.pelitabangsa.uts_satriaarya.R;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v == button2) {
            ...
            String url = "https://samehadaku.vip";
